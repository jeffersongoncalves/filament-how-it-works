...
namespace JeffersonGoncalves\FilamentHowItWorks\Tests;
...
use JeffersonGoncalves\FilamentHowItWorks\FilamentHowItWorksServiceProvider;
use JeffersonGoncalves\FilamentHowItWorks\Tests\Fixtures\TestPanelProvider;
use JeffersonGoncalves\FilamentHowItWorks\Tests\Fixtures\TestUser;
...
abstract class TestCase extends BaseTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            FilamentHowItWorksServiceProvider::class,
    ...
    protected function defineDatabaseMigrations(): void
    {
        ...
        $this->loadHowItWorksVendorMigrations([
    ...
    /**
     * Copy the vendored `*.php.stub` migrations for `jeffersongoncalves/laravel-how-it-works`
     ...
     */
    protected function loadHowItWorksVendorMigrations(array $migrations): void
    {
        $tempPath = sys_get_temp_dir().'/filament-how-it-works-vendor-migrations';
        ...
        $base = InstalledVersions::getInstallPath('jeffersongoncalves/laravel-how-it-works');
